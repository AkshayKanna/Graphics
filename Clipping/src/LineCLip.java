...
public class LineCLip extends javax.swing.JFrame {
    ...
    private void clipBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_clipBtnMouseClicked
        ...
        for (int i=0; i < 6; i++)
        {
           ...
           System.out.println("reg1 :"+p1regcode+" reg2:"+p2regcode);
           ...
           else
           {
               if(p1regcode == 0)
               {
                   ...
                   float m = y/x;
                   System.out.println(" x1:"+x1cord+" y1:"+y1cord+" x2:"+x2cord+" y2:"+y2cord);
                   ...
                   else if((p2regcode & right) == right)
                   {
                       xtemp = xmax;
                       float c = y1cord - (x1cord * m);
                       ytemp = m * xtemp + c;
                   }
                   else if((p2regcode & top) == top)
                   {
                   ...
                   else if((p2regcode & bottom) == bottom)
                   {
                       ytemp = ymin;
               ...
               else if(p2regcode == 0)
               {
                   ...
                   else if((p1regcode & right) == right)
                   {
                       xtemp = xmax;
                       float c = y1cord - (x1cord * m);
                       ytemp = m * xtemp + c;
                   }
                   else if((p1regcode & top) == top)
                   {
                       ytemp = ymax;
                       float c = y1cord - (x1cord * m);
                       xtemp = (ytemp - c)/m;
                   }
                   else if((p1regcode & bottom) == bottom)
                   {
                       ytemp = ymin;
                       float c = y1cord - (x1cord * m);
                       xtemp = (ytemp - c)/m;
